		...
		cy.request('GET', 'https://test.app.it-roast.com//front/pages/1').then(
			(res) => {
				...
				cy.task(
					...
					expect(res.body[1.1]).to.equal(result.rows[0].text)
				);
			}
		);
	});
		...
		cy.request('GET', 'https://test.app.it-roast.com//front/pages/1').then(
			(res) => {
				...
				cy.task(
					...
					expect(res.body[1.2]).to.equal(result.rows[0].text)
				);
			}
		);
	});
		...
		cy.request('GET', 'https://test.app.it-roast.com//front/pages/1').then(
			(res) => {
				...
				cy.task(
					...
					expect(res.body[1.3]).to.equal(result.rows[0].text)
				);
			}
		);
	});
		...
		cy.request('GET', 'https://test.app.it-roast.com//front/pages/1').then(
			(res) => {
				...
				cy.task(
					...
					expect(res.body[1.4]).to.equal(result.rows[0].text)
				);
			}
		);
	});
		...
		cy.request('GET', 'https://test.app.it-roast.com//front/pages/1').then(
			(res) => {
				...
				cy.task(
					...
					expect(res.body[1.5]).to.equal(result.rows[0].text)
				);
			}
		);
	});
		...
		cy.request('GET', 'https://test.app.it-roast.com//front/pages/1').then(
			(res) => {
				...
				cy.task(
					...
					expect(res.body[1.6]).to.equal(result.rows[0].text)
				);
			}
		);
	});
		...
		cy.request('GET', 'https://test.app.it-roast.com//front/pages/1').then(
			(res) => {
				...
				cy.task(
					...
					expect(res.body[1.7]).to.equal(result.rows[0].text)
				);
			}
		);
	});
		...
		cy.request('GET', 'https://test.app.it-roast.com//front/pages/1').then(
			(res) => {
				...
				cy.task(
					...
					expect(res.body[1.8]).to.equal(result.rows[0].text)
				);
			}
		);
	});
		...
		cy.request('GET', 'https://test.app.it-roast.com//front/pages/1').then(
			(res) => {
				...
				cy.task(
					...
					expect(res.body[1.9]).to.equal(result.rows[0].text)
				);
			}
		);
	});
